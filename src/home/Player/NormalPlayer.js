                ...
                <div className={style['normal-player']} style={{ display: isFullScreen ? '' : 'none' }}>
                    ...
                    <div className={`${style.bottom} bottom`}>
                        ...
                        <div className={`${style['control-wrapper']} ${songReady ? '' : style.disable}`}>
                            ...
                            {/* 切换上一首 */}
                            <div><span className={'iconfont icon-shangyishou'} onClick={this.prev} style={{ fontSize: "35px" }} /></div>
                            {/* 切换暂停播放 */}
                            <div><span className={`iconfont ${playing ? 'icon-bofang2' : 'icon-play_icon'}`}
                                onClick={this.togglePlay} style={{ fontSize: "45px" }} /></div>
                            {/* 切换下一首 */}
                            <div><span className={'iconfont icon-xiayishou'} onClick={this.next} style={{ fontSize: "35px" }} /></div>
                            {/* 添加喜欢 */}
